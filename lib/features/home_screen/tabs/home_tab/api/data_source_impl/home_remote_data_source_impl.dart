...
import 'package:online_exam_app/features/home_screen/tabs/home_tab/api/models/get_exam_questions_request_dto.dart';
...
class HomeRemoteDataSourceImpl extends HomeRemoteDataSource {
  ...
  Future<ApiResult<GetExamQuestionsResponseEntity>> getExamQuestions(
    ...
    try {
      if (getExamQuestionsRequestEntity.subjectId == null) {
        return ApiErrorResult(errorMsg: 'Subject ID is required');
      }
