...
class _ProfileApiClient implements ProfileApiClient {
  ...
  @override
  Future<GetUserDataResponseDto> getUserData() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetUserDataResponseDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late GetUserDataResponseDto _value;
    try {
      _value = GetUserDataResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<EditProfileResponseDto> editProfile(
      EditProfileRequestDto editProfileRequestDto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ChangePasswordResponseDto> changePassword(
      ChangePasswordRequestDto changePasswordRequestDto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
