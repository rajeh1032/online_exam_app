...
import '../../features/home_screen/tabs/result_tab/data/datasources/exam_result_local_data_source_impl.dart'
    as _i767;
import '../../features/home_screen/tabs/result_tab/data/repositories/exam_result_repository_impl.dart'
    as _i755;
import '../../features/home_screen/tabs/result_tab/domain/repositories/exam_result_repository.dart'
    as _i875;
import '../../features/home_screen/tabs/result_tab/domain/usecases/clear_all_results_use_case.dart'
    as _i474;
import '../../features/home_screen/tabs/result_tab/domain/usecases/delete_exam_result_use_case.dart'
    as _i550;
import '../../features/home_screen/tabs/result_tab/domain/usecases/get_all_exam_results_use_case.dart'
    as _i644;
import '../../features/home_screen/tabs/result_tab/domain/usecases/get_exam_result_use_case.dart'
    as _i379;
import '../../features/home_screen/tabs/result_tab/domain/usecases/get_exam_results_by_title_use_case.dart'
    as _i1063;
import '../../features/home_screen/tabs/result_tab/domain/usecases/get_recent_results_use_case.dart'
    as _i401;
import '../../features/home_screen/tabs/result_tab/domain/usecases/has_exam_result_use_case.dart'
    as _i1012;
import '../../features/home_screen/tabs/result_tab/domain/usecases/save_exam_result_use_case.dart'
    as _i341;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i765.ExamResultLocalDataSource>(
        () => _i767.ExamResultLocalDataSourceImpl());
    ...
    gh.factory<_i474.ClearAllResultsUseCase>(
        () => _i474.ClearAllResultsUseCase(gh<_i875.ExamResultRepository>()));
    gh.factory<_i550.DeleteExamResultUseCase>(
        () => _i550.DeleteExamResultUseCase(gh<_i875.ExamResultRepository>()));
    gh.factory<_i644.GetAllExamResultsUseCase>(
        () => _i644.GetAllExamResultsUseCase(gh<_i875.ExamResultRepository>()));
    gh.factory<_i1063.GetExamResultsByTitleUseCase>(() =>
        _i1063.GetExamResultsByTitleUseCase(gh<_i875.ExamResultRepository>()));
    gh.factory<_i379.GetExamResultUseCase>(
        () => _i379.GetExamResultUseCase(gh<_i875.ExamResultRepository>()));
    gh.factory<_i401.GetRecentResultsUseCase>(
        () => _i401.GetRecentResultsUseCase(gh<_i875.ExamResultRepository>()));
    gh.factory<_i1012.HasExamResultUseCase>(
        () => _i1012.HasExamResultUseCase(gh<_i875.ExamResultRepository>()));
    gh.factory<_i341.SaveExamResultUseCase>(
        () => _i341.SaveExamResultUseCase(gh<_i875.ExamResultRepository>()));
    ...
    gh.factory<_i511.ExamResultCubit>(() => _i511.ExamResultCubit(
          ...
          getAllExamResultsUseCase: gh<_i644.GetAllExamResultsUseCase>(),
          deleteExamResultUseCase: gh<_i550.DeleteExamResultUseCase>(),
          clearAllResultsUseCase: gh<_i474.ClearAllResultsUseCase>(),
          hasExamResultUseCase: gh<_i1012.HasExamResultUseCase>(),
          getExamResultsByTitleUseCase:
